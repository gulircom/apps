...
use function gulir_get_overlay_2;
...
class Overlay_2 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-overlay-2';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Overlay', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_overlay_2' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo gulir_get_overlay_2( $settings );
		}
	}
}