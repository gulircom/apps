...
use function gulir_get_grid_box_2;
...
class Grid_Box_2 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-grid-box-2';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Boxed Grid 2', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_grid_box_2' ) ) {

			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo gulir_get_grid_box_2( $settings );
		}
	}
}