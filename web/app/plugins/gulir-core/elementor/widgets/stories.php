...
class Web_Stories extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-stories';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Web Stories', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'blockType',
			[
				'label'       => esc_html__( 'Block Type', 'gulir-core' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Select web stories type.', 'gulir-core' ),
				'options'     => [
					'latest-stories'   => esc_html__( 'Latest Stories', 'gulir-core' ),
					'selected-stories' => esc_html__( 'Selected Stories', 'gulir-core' ),
				],
		...
		$this->add_control(
			'stories',
			[
				'label'       => esc_html__( 'Stories', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Input story IDs, separated by commas, i.e., 1, 2, 3.', 'gulir-core' ),
				'placeholder' => '1,2,3',
				'ai'          => [ 'active' => false ],
				'condition'   => [
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'date'  => esc_html__( 'Date', 'gulir-core' ),
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'asc'  => esc_html__( 'Ascending', 'gulir-core' ),
					'desc' => esc_html__( 'Descending', 'gulir-core' ),
				],
				'default' => 'asc',
			]
		);
		$this->add_control(
			'web_story_category',
			[
				'label'       => esc_html__( 'Categories IDs', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Input story category IDs, separated by commas, i.e., 1, 2, 3.', 'gulir-core' ),
				'placeholder' => '1,2,3',
				'ai'          => [ 'active' => false ],
				'default'     => '',
			]
		...
		$this->add_control(
			'web_story_tag',
			[
				'label'       => esc_html__( 'Tag IDs', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Input story tag IDs, separated by commas, i.e., 1, 2, 3.', 'gulir-core' ),
				'placeholder' => '1,2,3',
				'ai'          => [ 'active' => false ],
				'default'     => '',
			]
		...
		$this->add_control(
			'authors',
			[
				'label'       => esc_html__( 'Authors IDs', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'description' => esc_html__( 'Input author IDs, separated by commas, i.e., 1, 2, 3.', 'gulir-core' ),
				'placeholder' => '1,2,3',
				'ai'          => [ 'active' => false ],
				'default'     => '',
			]
		...
		$this->add_control(
			'numOfStories',
			[
				'label'   => esc_html__( 'Num of Stories', 'gulir-core' ),
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Layout', 'gulir-core' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Select a layout for the stories', 'gulir-core' ),
				'options'     => [
					'grid'     => esc_html__( 'Grid', 'gulir-core' ),
					'circles'  => esc_html__( 'Circle', 'gulir-core' ),
					'carousel' => esc_html__( 'Carousel', 'gulir-core' ),
		...
		$this->add_control(
			'show_title',
			[
				'label'     => esc_html__( 'Display Title', 'gulir-core' ),
		...
		$this->add_control(
			'circleSize',
			[
				'label'     => esc_html__( 'Circle Size', 'gulir-core' ),
				'type'      => Controls_Manager::NUMBER,
				'condition' => [
					'viewType' => 'circles',
				],
		...
		$this->add_control(
			'show_author',
			[
				'label'     => esc_html__( 'Display Author', 'gulir-core' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'condition' => [
					'viewType!' => 'circles',
		...
		$this->add_control(
			'show_date',
			[
				'label'     => esc_html__( 'Display Date', 'gulir-core' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'condition' => [
					'viewType!' => 'circles',
		...
		$this->add_control(
			'show_excerpt',
			[
				'label'   => esc_html__( 'Display Excerpt', 'gulir-core' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			]
		);
		$this->add_control(
			'imageAlignment',
			[
				'label'     => esc_html__( 'Image Align', 'gulir-core' ),
				'type'      => Controls_Manager::SELECT,
				'condition' => [
					'viewType' => 'list',
				],
		...
		$this->add_control(
			'sharp_corners',
			[
				'label'   => esc_html__( 'Use Sharp Corners', 'gulir-core' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			]
		);
		$this->add_control(
			'show_archive_link',
			[
				'label'   => esc_html__( 'Display Archive Link', 'gulir-core' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		$this->add_control(
			'archive_link_label',
			[
				'label'       => esc_html__( 'Archive Link Label', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'ai'          => [ 'active' => false ],
				'placeholder' => esc_html__( 'View All Stories', 'gulir-core' ),
				'condition'   => [
		...
		$this->add_control(
			'numOfColumns',
			[
				'label'     => esc_html__( 'Num of Columns', 'gulir-core' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 2,
				'condition' => [
					'viewType' => 'grid',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label'    => esc_html__( 'Excerpt Font', 'gulir-core' ),
				'name'     => 'excerpt_font',
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label'    => esc_html__( 'Meta Author, Date Font', 'gulir-core' ),
				'name'     => 'meta_font',
	...
	protected function render() {
		...
		if ( gulir_is_edit_mode() ) {
			...
			if ( ! class_exists( '\Google\Web_Stories\Plugin' ) ) {
				esc_html_e( 'Web Stories Plugin Not Found, please install it first to use this block.', 'gulir-core' );
			} else {
				esc_html_e( 'Web Stories Placeholder', 'gulir-core' );
			}
			echo '</div>';
