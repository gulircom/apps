...
use function gulir_get_grid_personalize_1;

class Grid_Personalize_1 extends Widget_Base {

	public function get_name() {

		return 'gulir-grid-recommended-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Personalized Grid 1', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_grid_personalize_1' ) ) {
			$settings             = $this->get_settings();
			$settings['uuid']     = 'uid_' . $this->get_id();
			$settings['readmore'] = 1;
			echo gulir_get_grid_personalize_1( $settings );
		}
	}
