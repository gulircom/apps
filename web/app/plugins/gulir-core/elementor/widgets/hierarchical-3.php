...
use function gulir_get_hierarchical_3;
...
class Hierarchical_3 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-hierarchical-3';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Hierarchical 3', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_hierarchical_3' ) ) {
			...
			echo gulir_get_hierarchical_3( $settings );
		}
	}
}