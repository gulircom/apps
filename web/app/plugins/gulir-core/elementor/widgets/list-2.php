...
class List_2 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Gulir - List 2', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'This layout is best suited for a content section or full width section with 2 columns.', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_2' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo gulir_get_list_2( $settings );
		}
	}
}