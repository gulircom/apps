...
use function gulir_get_overlay_flex;
...
class Overlay_Flex extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-overlay-flex';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Flex Overlay', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'nav_size',
			[
				'label'     => esc_html__( 'Nav, Dots Size', 'gulir-core' ),
				'type'      => Controls_Manager::NUMBER,
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_overlay_flex' ) ) {
			...
			echo gulir_get_overlay_flex( $settings );
		}
	}
}