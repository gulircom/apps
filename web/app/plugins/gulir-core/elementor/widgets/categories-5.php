...
use function gulir_get_categories_5;
...
class Categories_List_5 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-categories-5';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Taxonomies List 5', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'image_width', [
				...
				'description' => esc_html__( 'Input a max width value for the featured image.', 'gulir-core' ),
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_categories_5' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo gulir_get_categories_5( $settings );
		}
	}
}