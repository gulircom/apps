...
use function gulir_get_authors_1;
...
class Authors_List_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-authors-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Authors List 1', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'align', [
				'label'     => esc_html__( 'Image Alignment', 'gulir-core' ),
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_authors_1' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo gulir_get_authors_1( $settings );
		}
	}
}