...
use function gulir_header_font_resizer;
...
class Font_Resizer_Icon extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-font-resizer';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Font Resizer', 'gulir-core' );
	}
	...
	public function get_keywords() {
		...
		return [ 'gulir', 'ruby', 'header', 'template', 'builder', 'size', 'single', 'read' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'             => esc_html__( 'This block is only display in the single post.', 'gulir-core' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__( 'Select a custom font size for the font resizer icon.', 'gulir-core' ),
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Select a custom height value for the font resizer icon.', 'gulir-core' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__( 'Select a color for the font resizer icon.', 'gulir-core' ),
				'default'     => '',
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'description' => esc_html__( 'Select a color for the font resizer icon in dark mode.', 'gulir-core' ),
				'default'     => '',
