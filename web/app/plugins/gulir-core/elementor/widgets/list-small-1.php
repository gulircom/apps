...
use function gulir_get_list_small_1;
...
class List_Small_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-list-small-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Small List 1', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'This layout is best suited for putting to section 25 ~ 33% of width with 1 column.', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			'scroll_section', [
				'label' => esc_html__( 'Scrolling Mode', 'gulir-core' ),
				'tab'   => Controls_Manager::TAB_LAYOUT,
			]
		);
		$this->add_control(
			'scroll',
			[
				'label'       => esc_html__( 'Scroll Bar', 'gulir-core' ),
				'type'        => Controls_Manager::SELECT,
		...
		$this->add_control(
			'scroll_height',
			[
				'label'       => esc_html__( 'Block Height', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'ai'          => [ 'active' => false ],
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_small_1' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo gulir_get_list_small_1( $settings );
		}
	}
}