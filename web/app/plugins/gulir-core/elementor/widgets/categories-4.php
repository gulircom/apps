...
use function gulir_get_categories_4;
...
class Categories_List_4 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-categories-4';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Taxonomies List 4', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_categories_4' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo gulir_get_categories_4( $settings );
		}
	}
}