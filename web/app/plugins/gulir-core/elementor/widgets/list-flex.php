...
use function gulir_get_list_flex;
...
class List_Flex extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-list-flex';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Flex List', 'gulir-core' );
	}
	...
	public function get_keywords() {
		...
		return [ 'gulir', 'ruby', 'post', 'listing', 'blog', 'flex' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Allow you to sort order elements to show such as title, meta, excerpt...', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'ai'          => [ 'active' => false ],
				'rows'        => 2,
				'description' => esc_html__( 'Input element keys to show, separate by comma. e.g. title, meta, excerpt', 'gulir-core' ),
		...
		$this->add_control(
			'overlay_category',
			[
				'label'       => esc_html__( 'Overlay Entry Category', 'gulir-core' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Enable or disable the entry category on the feature image.', 'gulir-core' ),
				'options'     => [
		...
		$this->add_control(
			'flipped',
			[
				'label'        => esc_html__( 'Featured Flipped', 'gulir-core' ),
				'type'         => Controls_Manager::SELECT,
				'description'  => esc_html__( 'Display the featured image flipped, first on the left side and then on the right side.', 'gulir-core' ),
				'options'      => [
					'no'  => esc_html__( '- Default -', 'gulir-core' ),
					'yes' => esc_html__( 'Flipped', 'gulir-core' ),
				],
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_flex' ) ) {
			...
			echo gulir_get_list_flex( $settings );
		}
	}
}