...
use function gulir_get_classic_1;
...
class Classic_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-classic-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Classic', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'content_width', [
				'label'       => esc_html__( 'Content Max Width', 'gulir-core' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Input a max width value (in px) for the content of this layout.', 'gulir-core' ),
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_classic_1' ) ) {
			...
			echo gulir_get_classic_1( $settings );
		}
	}
}