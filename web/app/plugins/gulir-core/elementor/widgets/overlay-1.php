...
use function gulir_get_overlay_1;
...
class Overlay_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-overlay-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Highlight Overlay', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'mobile_overlay_bg',
			[
				'label'     => esc_html__( 'Mobile Background', 'gulir-core' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->start_controls_section(
			'slider_section', [
				'label' => esc_html__( 'Slider Mode', 'gulir-core' ),
				'tab'   => Controls_Manager::TAB_LAYOUT,
			]
		);
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'The ajax pagination and columns settings will be not available if the slider mode is activated.', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
			]
		);
		$this->add_control(
			'slider',
			[
				'label'       => esc_html__( 'Slider', 'gulir-core' ),
				'type'        => Controls_Manager::SELECT,
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Enable or disable the pagination dot for this slider.', 'gulir-core' ),
				'options'     => Options::switch_dropdown( false ),
				'default'     => '1',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Enable or disable the next/prev navigation dot for this slider', 'gulir-core' ),
				'options'     => Options::switch_dropdown( false ),
				'default'     => '-1',
			]
		);
		...
		$this->add_responsive_control(
			'slider_nav_position',
			[
				'label'       => esc_html__( 'Next/Prev Icons Top Position', 'gulir-core' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Input a position (percentage) from the top for the next and previous slider buttons', 'gulir-core' ),
		...
		$this->add_responsive_control(
			'nav_size',
			[
				'label'     => esc_html__( 'Next/Prev Size', 'gulir-core' ),
				'type'      => Controls_Manager::NUMBER,
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'description' => esc_html__( 'Select a color for the slider dots and navigation controls of this slider.', 'gulir-core' ),
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'description' => esc_html__( 'Select a color for the slider dots and navigation controls of this slider in the dark mode.', 'gulir-core' ),
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_overlay_1' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo gulir_get_overlay_1( $settings );
		}
	}
}