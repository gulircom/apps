...
use function gulir_get_grid_flex_1;
...
class Grid_Flex_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-grid-flex-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Flex Grid 1', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Keys include: [title, thumbnail, meta, review, excerpt, readmore, divider, images]', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			'teaser_section', [
				'label' => esc_html__( 'Teaser Images', 'gulir-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Display some of the first images of post content in the listing.', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Use the keyword: "images" in the Block Structure to enable this section.', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Select number of images (columns) to show', 'gulir-core' ),
				'options'     => [
					'2' => esc_html__( '2', 'gulir-core' ),
					'3' => esc_html__( '3', 'gulir-core' ),
					'4' => esc_html__( '4', 'gulir-core' ),
				],
				'default'     => '3',
				'selectors'   => [
		...
		$this->add_control(
			'teaser_link',
			[
				'label'   => esc_html__( 'Is Clickable?', 'gulir-core' ),
		...
		$this->add_control(
			'teaser_size',
			[
				'label'   => esc_html__( 'Teaser Image Size', 'gulir-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => Options::crop_size_dropdown(),
				'default' => '0',
			]
		...
		$this->add_responsive_control(
			'teaser_ratio', [
				'label'     => esc_html__( 'Custom Images Ratio', 'gulir-core' ),
				'type'      => Controls_Manager::NUMBER,
				'selectors' => [
		...
		$this->add_responsive_control(
			'teaser_gap', [
				'label'     => esc_html__( 'Gap Spacing', 'gulir-core' ),
				'type'      => Controls_Manager::NUMBER,
				'selectors' => [
		...
		$this->add_control(
			'featured_list_width', [
				'label'       => esc_html__( 'Mobile List - Image Width', 'gulir-core' ),
				'type'        => Controls_Manager::NUMBER,
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_grid_flex_1' ) ) {
			...
			echo gulir_get_grid_flex_1( $settings );
		}
	}
}