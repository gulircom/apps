...
use function gulir_get_list_small_3;
...
class List_Small_3 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-list-small-3';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Small List 3', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_small_3' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo gulir_get_list_small_3( $settings );
		}
	}
}