...
use function gulir_get_list_small_2;
...
class List_Small_2 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-list-small-2';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Small List 2', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'feat_spacing', [
				'label'       => esc_html__( 'Custom Featured Margin', 'gulir-core' ),
				'type'        => Controls_Manager::NUMBER,
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_small_2' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo gulir_get_list_small_2( $settings );
		}
	}
}