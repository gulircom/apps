...
use function gulir_get_list_box_1;
...
class List_Box_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-list-box-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Boxed List 1', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_box_1' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo gulir_get_list_box_1( $settings );
		}
	}
}