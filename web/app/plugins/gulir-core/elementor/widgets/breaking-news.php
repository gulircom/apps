...
use function gulir_get_breaking_news;
...
class Breaking_News extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-breaking-news';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Breaking News', 'gulir-core' );
	}
	...
	public function get_keywords() {
		...
		return [ 'gulir', 'ruby', 'sticker', 'slider' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'This layout is best suited for all sections.', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
			'heading', [
				'label'       => esc_html__( 'Heading Label', 'gulir-core' ),
				'type'        => Controls_Manager::TEXT,
				'ai'          => [ 'active' => false ],
				'description' => esc_html__( 'input a heading label for this block.', 'gulir-core' ),
				'default'     => esc_html__( 'Hot News', 'gulir-core' ),
			]
		);
		$this->add_responsive_control(
			'label_size', [
				...
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'Input a custom font size for the label', 'gulir-core' ),
		...
		$this->add_group_control(
			...
			[
				'label'    => esc_html__( 'Heading Label Font', 'gulir-core' ),
				'name'     => 'font_label',
		...
		$this->add_responsive_control(
			'title_tag_size', [
				'label'       => esc_html__( 'Post Title Font Size', 'gulir-core' ),
				'type'        => Controls_Manager::NUMBER,
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label'    => esc_html__( 'Post Title Font', 'gulir-core' ),
				'name'     => 'title_font',
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_breaking_news' ) ) {
			...
			echo gulir_get_breaking_news( $settings );
		}
	}
}