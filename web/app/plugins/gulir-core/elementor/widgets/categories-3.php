...
use function gulir_get_categories_3;
...
class Categories_List_3 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-categories-3';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Taxonomies List 3', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'description',
			[
				'label'       => esc_html__( 'Category Description', 'gulir-core' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => Options::switch_dropdown( false ),
				'description' => esc_html__( 'Enable or disable the category description.', 'gulir-core' ),
				'default'     => '1',
			]
		);
		$this->add_group_control(
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_categories_3' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo gulir_get_categories_3( $settings );
		}
	}
}