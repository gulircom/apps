...
use function gulir_get_list_personalize;

class List_Personalize extends Widget_Base {

	public function get_name() {

		return 'gulir-list-personalize';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Personalized List', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_list_personalize' ) ) {
			...
			echo gulir_get_list_personalize( $settings );
		}
	}
}