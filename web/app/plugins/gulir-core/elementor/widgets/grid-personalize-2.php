...
use function gulir_get_grid_personalize_2;

class Grid_Personalize_2 extends Widget_Base {

	public function get_name() {

		return 'gulir-grid-recommended-2';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Personalized Grid 2', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Keys include: [title, thumbnail, meta, review, excerpt, readmore, divider]', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_grid_personalize_2' ) ) {

			$settings             = $this->get_settings();
			$settings['uuid']     = 'uid_' . $this->get_id();
			$settings['readmore'] = 1;

			echo gulir_get_grid_personalize_2( $settings );
		}
	}
