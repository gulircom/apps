...
class Newsletter_2 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-newsletter-2';
	}

	public function get_title() {

		return esc_html__( 'Gulir - FW Newsletter 2', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'inner_padding', [
				'label'       => esc_html__( 'Inner Padding', 'gulir-core' ),
				'type'        => Controls_Manager::DIMENSIONS,
				'description' => esc_html__( 'Input a custom inner padding for this block.', 'gulir-core' ),
