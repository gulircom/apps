...
if ( ! class_exists( 'Gulir_Video_Thumb', false ) ) {
	class Gulir_Video_Thumb {
		...
		function __construct() {
			...
			add_filter( 'gulir_playlist_thumbnails', [ $this, 'playlist_thumbnails' ], 10, 1 );
		}
		...
		public function post_video_thumbnail( $post_id ) {
			...
			if ( ! gulir_get_option( 'auto_video_featured' ) ) {
				return;
			}
...
/** load */
Gulir_Video_Thumb::get_instance();
