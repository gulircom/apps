...
use function gulir_get_podcast_overlay_flex_1;
...
class Podcast_Overlay_Flex_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-podcast-overlay-flex-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Podcast Flex Overlay', 'gulir-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_podcast_overlay_flex_1' ) ) {
			...
			echo gulir_get_podcast_overlay_flex_1( $settings );
		}
	}
}