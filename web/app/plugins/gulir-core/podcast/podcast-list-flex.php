...
use function gulir_get_podcast_list_flex_1;
...
class Podcast_List_Flex_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'gulir-podcast-list-flex-1';
	}

	public function get_title() {

		return esc_html__( 'Gulir - Podcast Flex List', 'gulir-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Allow you to sort order elements to show such as title, meta...', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Keys include: [category, title, meta, review, excerpt, readmore, divider, player ]', 'gulir-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
			...
			[
				...
				'ai'          => [ 'active' => false ],
				'rows'        => 2,
				'description' => esc_html__( 'Input element keys to show, separate by comma. e.g. title, meta', 'gulir-core' ),
	...
	protected function render() {
		...
		if ( function_exists( 'gulir_get_podcast_list_flex_1' ) ) {
			...
			echo gulir_get_podcast_list_flex_1( $settings );
		}
	}
}