...
<div class="rb-dashboard-wrap">
	<div class="rb-dashboard-intro rb-dashboard-section rb-dashboard-fw">
		<div class="rb-intro-content">
			<div class="rb-intro-content-inner">
				<h1 class="rb-dashboard-headline"><?php esc_html_e( 'Registration License', 'gulir-core' ); ?></h1>
				<p class="rb-dashboard-tagline"><?php esc_html_e( 'Please enter the purchase code in the input field provided. This code verifies your license and unlocks all premium features of the theme.', 'gulir-core' ); ?></p>
			</div>
		...
		<div class="rb-activate-form">
			<form method="post" action="" id="rb-register-theme-form">
				<div class="rb-panel-input">
					<label class="rb-panel-label" for="purchase_code"><?php esc_html_e( 'Purchase Code', 'gulir-core' ); ?></label>
					<input type="text" name="purchase_code" class="rb-panel-input-text" placeholder="<?php esc_html_e( 'Input purchase code...', 'gulir-core' ); ?>" required>
					<span class="rb-error-info is-hidden"><i class="dashicons-info-outline dashicons-before" aria-hidden="true"></i></span>
				</div>
				<div class="rb-panel-input">
					<label class="rb-panel-label" for="email"><?php esc_html_e( 'Support Email', 'gulir-core' ); ?></label>
					<input type="email" name="email" class="rb-panel-input-text" placeholder="<?php esc_html_e( 'Input your email...', 'gulir-core' ); ?>" required>
					<span class="rb-error-info is-hidden"><i class="dashicons-info-outline dashicons-before" aria-hidden="true"></i></span>
				</div>
				<div class="rb-panel-submit">
					<input id="rb-register-theme-btn" type="submit" class="rb-panel-button is-big-button" name="register-theme" value="<?php esc_attr_e( 'Activate License', 'gulir-core' ); ?>">
					<span class="rb-loading is-hidden"><i class="rbi-dash rbi-dash-load"></i></span>
					<span class="rb-purchase-code-info"><a href="#" role="button"><?php esc_html_e( 'How to find your purchase code?', 'gulir-core' ) ?></a></span>
				</div>
	...
	<div class="rb-dashboard-section rb-dashboard-fw">
		<div class="rb-section-header"><h2>
				<i class="rbi-dash rbi-dash-info"></i><?php esc_html_e( 'PHP Information', 'gulir-core' ); ?></h2></div>
