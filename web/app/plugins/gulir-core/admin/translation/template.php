		...
		<div class="rb-intro-content yes-button">
			<div class="rb-intro-content-inner">
				<h2 class="rb-dashboard-title">
					<i class="rbi-dash rbi-dash-translate" aria-hidden="true"></i><?php esc_html_e( 'Quick Translation', 'gulir-core' ); ?>
				</h2>
				<p class="rb-dashboard-tagline"><?php esc_html_e( 'Allows you to quickly translate front-end strings to your language.', 'gulir-core' ); ?></p>
			</div>
			<div class="rb-intro-buttons">
				<button type="submit" class="rb-panel-button is-outlined" name="fetch-translation" id="rb-fetch-translation">
					<i class="rbi-dash rbi-dash-cloud"></i><?php esc_html_e( 'Update Strings', 'gulir-core' ) ?>
				</button>
			</div>
		</div>
		<div class="rb-dashboard-tips">
			<p><i class="dashicons dashicons-info"></i><?php echo esc_html__( 'PLEASE NOTE: Please keep "%s" as it is in the translated text if the string contains this variable. Incorrect formatting can cause fatal errors in PHP code and prevent the site from loading correctly.', 'gulir-core' ); ?></p>
		</div>
		<div class="rb-translation">
			<?php if ( empty( $data ) || ! is_array( $data ) || ! count( $data ) ) : ?>
				<h3 class="rb-notice"><?php esc_html_e( 'POT files not found.', 'gulir-core' ); ?></h3>
			<?php else : ?>
				...
				<div class="rb-translation-wrap">
					<div class="rb-translation-header">
						<h3 class="source-label">
							...
							<?php esc_html_e( 'Source String - English', 'gulir-core' ); ?></h3>
						<h3 class="translation-label">
							<i class="rbi-dash rbi-dash-translate"></i>
							<?php esc_html_e( 'Translation', 'gulir-core' ); ?>
						</h3>
					</div>
					...
					<div class="rb-form-sticky">
						<div class="rb-translation-search">
							<div class="scs-form">
								<input id="rb-search-form" type="text" placeholder="<?php esc_html_e( 'Search source string...', 'gulir-core' ); ?>">
						...
						<div class="rb-translation-submit">
							...
							<input type="submit" class="rb-panel-button is-big-button" value="<?php esc_html_e( 'Save Changes', 'gulir-core' ) ?>" name="update-translation" id="rb-update-translation">
						</div>
					</div>
				</div>
			</div>
