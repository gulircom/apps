...
if ( ! class_exists( 'Gulir_MC4WP_Integration' ) ) {
	class Gulir_MC4WP_Integration extends MC4WP_Integration {

		/**
		 * @var string
		 */
		public $name = 'Gulir Subscribe';
		/**
		 * @var string
		 */
		public $description = 'Integrate with Gulir Subscribe to Download.';
		...
		public function add_hooks() {
			...
			add_action( 'gulir_subscribe', [ $this, 'process' ], 1 );
		}
