            ...
            public function render() {
                ...
                if ( ! empty( $this->field['raw_html'] ) && $this->field['raw_html'] ) {
                    ...
                    if ( isset( $this->field['title'] ) && ! empty( $this->field['title'] ) ) {
                        $this->field['title'] = '<b>' . html_entity_decode($this->field['title']) . '</b><br/>';
                    }
                ...
                echo '</div><table class="form-table no-border" style="margin-top: 0;"><tbody><tr class="no-border" style="border-bottom:0; display:none;"><th style="padding-top:0;"></th><td style="padding-top:0;">';
            }
