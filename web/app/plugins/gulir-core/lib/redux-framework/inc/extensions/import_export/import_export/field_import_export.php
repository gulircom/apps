...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework_import_export' ) ) {
        ...
        class ReduxFramework_import_export extends ReduxFramework {
             ...
             * @return      void
             */
	        public $parent, $field, $value, $extension_dir, $is_field, $extension_url;
            ...
            public function render() {
                ...
                ?>
                <div id="info-heading_layout_notice" class="redux-warning redux-notice-field redux-field-info backup-notice">
                    <p class="redux-info-desc">You should backup your settings regularly. Before you update or do major changes.</p>
                </div>
                    <h4><?php esc_html_e( 'Restore Your Settings', 'redux-framework' ); ?></h4>
                    ...
                    <h4><?php esc_html_e( 'Backup Your Settings', 'redux-framework' ) ?></h4>
