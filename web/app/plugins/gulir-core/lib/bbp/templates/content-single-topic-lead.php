    ...
    <div id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
        ...
        <div id="post-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
            ...
            <div class="bbp-reply-footer meta-text">
                <a href="<?php bbp_topic_permalink(); ?>" data-link="<?php bbp_topic_permalink(); ?>" class="copy-trigger bbp-reply-permalink bbp-copy-link" data-copy="<?php echo gulir_attr__( 'Copy Link', 'ruby-bbp' ); ?>" data-copied="<?php echo gulir_attr__( 'Added to Clipboard', 'ruby-bbp' ); ?>"><i class="bbp-rbi-copy" aria-hidden="true"></i> #<?php bbp_topic_id(); ?>
                </a>
