    ...
    <div class="bbp-search-form">
        <form role="search" method="get" id="bbp-reply-search-form">
            <div class="bbp-search-form-inner">
                ...
                <input type="text" placeholder="<?php echo get_option( 'ruby_bbp_search_reply_placeholder', gulir_attr__( 'Search for Replies', 'ruby-bbp' ) ); ?>" value="<?php bbp_search_terms(); ?>" name="rs" id="rs"/>
