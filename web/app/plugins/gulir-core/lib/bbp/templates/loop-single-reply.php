...
<div id="post-<?php bbp_reply_id(); ?>" <?php bbp_reply_class(); ?>>
    <div class="bbp-meta bbp-reply-header">
		...
		<?php endif; ?>
	    <?php if ( 'topic' === get_post_type( bbp_get_reply_id() ) ) {
		    the_title( '<h2 class="bbp-single-topic-title">', '</h3>' );
	    } ?>
    </div>
    <div class="bbp-reply-author">
        ...
        <div class="bbb-reply-author-content">
			...
			<?php if ( current_user_can( 'moderate', bbp_get_reply_id() ) ) : ?>
                <span class="bbp-reply-ip is-meta"><?php bbp_author_ip( bbp_get_reply_id() ); ?></span>
			<?php endif; ?>
    ...
    <div class="bbp-reply-footer meta-text">
        <a href="<?php bbp_reply_url(); ?>" data-link="<?php bbp_reply_url(); ?>" class="copy-trigger bbp-reply-permalink bbp-copy-link" data-copy="<?php echo gulir_attr__( 'Copy Link', 'ruby-bbp' ); ?>" data-copied="<?php echo gulir_attr__( 'Added to Clipboard', 'ruby-bbp' ); ?>"><i class="bbp-rbi-copy" aria-hidden="true"></i> #<?php bbp_reply_id(); ?></a>
