...
if ( ! function_exists( 'ruby_bbp_validate_custom_fields' ) ) {
	function ruby_bbp_validate_custom_fields() {
		...
		foreach ( $data as $index => $field ) :
			...
			if ( empty( $content ) ) {
				bbp_add_error( $id, gulir_attr__( 'Your topic needs a ', 'ruby-bbp' ) . strtolower( $field['title'] . '.' ) );
			}
...
if ( ! function_exists( 'ruby_bbp_private_input_field' ) ) {
	function ruby_bbp_private_input_field( $output, $args, $post_content ) {
        ...
        <div class="bbp-the-content-wrapper">
            <label for="ruby_bbp_private_content"><i class="bbp-rbi-lock" aria-hidden="true"></i><?php echo gulir_attr__( 'Private Content', 'ruby-bbp' ); ?>
            </label>
			<?php
...
if ( ! function_exists( 'ruby_bbp_register_topic_status' ) ) {
	function ruby_bbp_register_topic_status( $post ) {
		...
		?>
        <p>
            <strong class="label"><?php echo gulir_attr__( 'Frontend Status:', 'ruby-bbp' ); ?></strong>
            <label class="screen-reader-text" for="parent_id"><?php echo gulir_attr__( 'Frontend Status', 'ruby-bbp' ); ?></label>
