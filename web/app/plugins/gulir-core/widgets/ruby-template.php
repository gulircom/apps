...
if ( ! class_exists( 'Gulir_W_Ruby_Template' ) ) {
	class Gulir_W_Ruby_Template extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Gulir - Ruby Template', 'gulir-core' ), [
				'classname'   => $this->widgetID,
				'description' => esc_html__( 'Display a ruby template in widget sections.', 'gulir-core' ),
			] );
		}
		...
		function form( $instance ) {
			...
			gulir_create_widget_select_field( [
				...
				'data'        => 'template',
				'title'       => esc_html__( 'Select a Template', 'gulir-core' ),
				'description' => esc_html__( 'Select a Ruby template to display in this sidebar.', 'gulir-core' ),
			...
			gulir_create_widget_text_field( [
				...
				'title'       => esc_html__( 'or Shortcode', 'gulir-core' ),
				'description' => esc_html__( 'Input a shortcode, this setting will override the setting above.', 'gulir-core' ),
