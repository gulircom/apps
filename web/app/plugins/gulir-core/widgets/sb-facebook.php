...
if ( ! class_exists( 'Gulir_W_Facebook' ) ) {

	class Gulir_W_Facebook extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Gulir - Widget Facebook', 'gulir-core' ), [
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display the Facebook Like box in the sidebar.', 'gulir-core' ),
			] );
		}
		...
		function form( $instance ) {
			...
			gulir_create_widget_text_field( [
				...
				'title' => esc_html__( 'Fan Page URL', 'gulir-core' ),
