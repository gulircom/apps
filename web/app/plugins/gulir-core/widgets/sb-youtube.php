...
if ( ! class_exists( 'Gulir_W_Youtube_Subscribe' ) ) :
	class Gulir_W_Youtube_Subscribe extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Gulir - Youtube Subscribe', 'gulir-core' ), [
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display YouTube subscribe box in the sidebar.', 'gulir-core' ),
			] );
		}
		...
		function form( $instance ) {
			...
			gulir_create_widget_heading_field( [
				...
				'title' => esc_html__( 'Youtube Settings', 'gulir-core' ),
			] );

			gulir_create_widget_text_field( [
				'id'    => $this->get_field_id( 'channel_name' ),
				'name'  => $this->get_field_name( 'channel_name' ),
				'title' => esc_html__( 'Channel Name', 'gulir-core' ),
			...
			gulir_create_widget_text_field( [
				...
				'title' => esc_html__( 'or Channel ID', 'gulir-core' ),
				'desc'  => esc_html__( 'this setting will override on the above channel name.', 'gulir-core' ),
